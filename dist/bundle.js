...
ngModule.run(['$templateCache', function ($templateCache) {
  $templateCache.put('src/components/app/app.template.html',
    ...
    '    <h1>Hello: {{ title }}</h1>\n' +
    '    <hr />\n' +
    '    <wa-counter></wa-counter>\n' +
    '</div>');
}]);

module.exports = "src/components/app/app.template.html";
